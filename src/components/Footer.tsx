function Footer() {
  ...
  return (
    <footer className="bg-neutral-primary-soft" id="contact">
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
              >
                <path d="M19 0H5C2.24 0 0 2.24 0 5v14c0 2.76 2.24 5 5 5h14c2.76 0 5-2.24 5-5V5c0-2.76-2.24-5-5-5zM7.12 20.45H3.56V9h3.56v11.45zM5.34 7.54a2.06 2.06 0 1 1 0-4.12 2.06 2.06 0 0 1 0 4.12zM20.45 20.45h-3.56v-5.6c0-1.34-.03-3.06-1.87-3.06-1.87 0-2.16 1.46-2.16 2.97v5.69H9.3V9h3.42v1.56h.05c.48-.9 1.66-1.87 3.42-1.87 3.66 0 4.33 2.41 4.33 5.54v6.22z" />
              </svg>
